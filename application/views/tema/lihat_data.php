  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="tema/post" method="POST">
                                             ...
                                             <td><?php echo $no?></td>
                                               <td><?php echo $r->tema_nama?></td>
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a title="Edit" class="btn btn-default" href="<?php echo site_url('tema/edit/'.$r->tema_id);?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                    
                                                    <a title="Hapus" class="btn btn-default" href="<?php echo site_url('tema/delete/'.$r->tema_id);?>"
